#!/bin/bash
# run_local.sh - Example 2: L-shaped bracket (manuscript Section 4.2)
# Optimized for a Threadripper PRO 5995WX (64 physical cores) reference
# workstation, as used for the wall-time figures reported in Section 4.2.
...
# ==============================================================================
echo "========================================================"
echo " Starting BESO L-shaped Bracket on 64 Physical Cores (Pure MPI)"
echo "========================================================"

# Launch with 64 MPI ranks
mpirun -np 64 python -u run_l_bracket.py
