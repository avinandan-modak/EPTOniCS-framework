#!/bin/bash
# run_local.sh - Example 3: V-notched portal (manuscript Section 4.3)
# Optimized for a Threadripper PRO 5995WX (64 physical cores) reference
# workstation, as used for the wall-time figures reported in Section 4.3.
...
# ==============================================================================
echo "========================================================"
echo " Starting BESO V-notched Portal on 64 Physical Cores (Pure MPI)"
echo "========================================================"

# Launch with 64 MPI ranks
mpirun -np 64 python -u run_portal_frame.py
